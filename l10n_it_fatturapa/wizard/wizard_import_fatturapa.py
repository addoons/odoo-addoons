...
from odoo.tools import float_is_zero, etree
from odoo.tools.translate import _
from odoo.exceptions import UserError

from ..bindings import fatturapa as fatturapa
    ...
    def importFatturaPA(self):
        ...
        for fatturapa_attachment_id in fatturapa_attachment_ids:
            ...
            for fattura in fatt.FatturaElettronicaBody:
                ...
                if invoice.date_invoice <= datetime.date(2019, 12, 31):
                    invoice.date = datetime.date(2020, 1, 1)
